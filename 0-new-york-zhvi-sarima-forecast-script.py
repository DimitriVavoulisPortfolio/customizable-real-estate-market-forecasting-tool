...
def load_models():
    script_dir = os.path.dirname(os.path.abspath(__file__))
    parent_dir = os.path.dirname(script_dir)
    models_dir = os.path.join(parent_dir, 'customizable-real-estate-market-forecasting-tool/models/New York')
    
    auto_arima_path = os.path.join(models_dir, 'New York_auto_arima_model.joblib')
    sarima_path = os.path.join(models_dir, 'New York_sarima_model.joblib')
